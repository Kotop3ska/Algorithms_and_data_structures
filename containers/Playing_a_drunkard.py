...
которые кладутся под низ его колоды. 
...
после чего вывести количество ходов, сделанных до выигрыша. Если на протяжении 10^6 ходов игра не заканчивается, 
...
for i in range(10**6):
    ...
    if 0 < first[0] - second[0] < 9 or second[0] - first[0] == 9:
